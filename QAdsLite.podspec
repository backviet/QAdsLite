Pod::Spec.new do |spec|
  ...
  spec.source        = { :http => 'https://github.com/backviet/QAdsLite/releases/download/0.0.18/QAdsLite.zip' }
  spec.swift_version = '5.0'
  spec.ios.deployment_target = '13.0'

  s.static_framework = true  # Ensure adslite is a static framework
  ...
  spec.dependency 'Google-Mobile-Ads-SDK', '~> 11.5.0', :optional => true
